...
public:
	...
	///enableFeedback will allow to readFBO the applied linear and angular impulse
	///use getAppliedImpulse, getAppliedLinearImpulse and getAppliedAngularImpulse to readFBO feedback information
